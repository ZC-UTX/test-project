...
// UnimplementedWorksServer must be embedded to have
...
func (UnimplementedWorksServer) testEmbeddedByValue()               {}
...
func RegisterWorksServer(s grpc.ServiceRegistrar, srv WorksServer) {
	// If the following call pancis, it indicates UnimplementedWorksServer was
