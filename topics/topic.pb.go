...
type ListsTopic struct {
	...
	HotScore   string `protobuf:"bytes,3,opt,name=HotScore,proto3" json:"HotScore,omitempty"`
	VideoSum   int64  `protobuf:"varint,4,opt,name=VideoSum,proto3" json:"VideoSum,omitempty"`
}
...
func (x *ListsTopic) GetHotScore() string {
	if x != nil {
		return x.HotScore
	}
	return ""
...
func (x *ListsTopic) GetVideoSum() int64 {
	if x != nil {
		return x.VideoSum
	}
	return 0
...
var file_topic_proto_rawDesc = []byte{
	...
	0x74, 0x53, 0x63, 0x6f, 0x72, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x48, 0x6f,
	0x74, 0x53, 0x63, 0x6f, 0x72, 0x65, 0x12, 0x1a, 0x0a, 0x08, 0x56, 0x69, 0x64, 0x65, 0x6f, 0x53,
	0x75, 0x6d, 0x18, 0x04, 0x20, 0x01, 0x28, 0x03, 0x52, 0x08, 0x56, 0x69, 0x64, 0x65, 0x6f, 0x53,
